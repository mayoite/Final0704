            ...
            <div className="px-4 py-3 space-y-3 text-sm">
              ...
              {step === 4 && (
                <div className="space-y-3">
                  ...
                  />
                  <div className="rounded-md bg-hover border border-soft px-3 py-2 typ-caption-lg leading-snug text-body">
                    <p className="font-medium mb-1">
                      Preview of what we receive:
                    </p>
                    <pre className="whitespace-pre-wrap typ-caption text-body">
                      {summary}
                    </pre>
                  </div>
