...
export const CONTACT_FORM_CONTEXT_COPY = {
  quote: {
    default: {
      ...
      title: "Tell us what your team needs priced",
      description:
        "Share the category mix, quantities, timeline, and any procurement constraints. We will route the request to the right commercial contact.",
      requirement: "General quote request",
      seededMessage:
        "I need a quote for my workspace requirement and want the right next commercial step.",
    },
    compare: {
  ...
  planning: {
    ...
    title: "Start a planning conversation",
    description:
      "Use this lane when seat count, layout density, zoning, or rollout sequencing still need work before procurement.",
    requirement: "Planning support request",
    seededMessage:
      "I need help with layout planning, seat count, and workspace specification before procurement.",
  },
  support: {
    eyebrow: "Support request",
    title: "Route an active service or delivery issue",
    description:
      "Use this lane for after-sales support, service follow-up, installation questions, or delivery-related help.",
    requirement: "Support request",
    seededMessage:
      "I need help with an active order, installation, warranty issue, or support request.",
  },
  documents: {
    eyebrow: "Documentation request",
    title: "Request technical sheets or category packs",
    description:
      "Use this lane when the next blocker is a brochure, technical sheet, finish reference, or planning document pack.",
    requirement: "Documentation request",
    seededMessage:
      "I need technical sheets, category packs, or planning documents for my workspace requirement.",
  },
} as const;
