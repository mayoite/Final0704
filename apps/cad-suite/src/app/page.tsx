        ...
        <div className="grid w-full gap-12 xl:grid-cols-[minmax(0,1.02fr)_minmax(26rem,0.98fr)] xl:items-center">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/planner"
                className="inline-flex items-center gap-2 rounded-full bg-[color:var(--planner-primary)] px-5 py-3 text-sm font-semibold text-white shadow-theme-float transition hover:bg-[color:var(--planner-primary-hover)] hover:scale-[1.03]"
              >
                Open Planner
              ...
              <Link
                href="/configurator"
                className="inline-flex items-center gap-2 rounded-full border border-[color:var(--planner-border-strong)] bg-white/70 px-5 py-3 text-sm font-semibold text-[color:var(--planner-text-strong)] shadow-theme-panel transition hover:border-[color:var(--planner-primary)]/35 hover:bg-white hover:scale-[1.03]"
              >
                Open 3D View
                <ArrowRight className="h-4 w-4" />
              </Link>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2.35rem] border border-white/80 bg-[color:var(--planner-panel-strong)]/88 p-5 shadow-theme-float backdrop-blur-xl sm:p-6">
              ...
              <div className="grid gap-4 lg:grid-cols-[1.08fr_0.92fr]">
                <Link
                  href="/planner"
                  className="group relative overflow-hidden rounded-[1.8rem] border border-white/85 bg-[linear-gradient(145deg,rgba(255,255,255,0.92),rgba(237,243,250,0.8))] p-5 shadow-theme-panel transition hover:-translate-y-1 hover:border-[color:var(--planner-primary)]/35 hover:shadow-theme-float"
                >
                  <div
                    aria-hidden
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-4 rounded-[1.45rem] border border-white/90 bg-white/84 p-4 shadow-theme-panel">
                      <div className="relative h-44 overflow-hidden rounded-[1.15rem] border border-[color:var(--planner-border-soft)] bg-[linear-gradient(180deg,rgba(250,252,255,0.98),rgba(238,244,250,0.88))] p-4">
                        ...
                        <div className="absolute bottom-4 left-6 right-6 flex items-center justify-between gap-3 text-[10px] font-semibold uppercase tracking-[0.18em] text-[color:var(--planner-text-subtle)]">
                          <span>Shell</span>
                          <span>Catalog</span>
                          <span>BOQ</span>
                        </div>
                    ...
                    <div className="mt-3 overflow-hidden transition-all duration-300 max-h-0 opacity-0 group-hover:max-h-16 group-hover:opacity-100">
                      <p className="text-xs leading-5 text-muted">
                        Draw rooms, place furniture, review measurements, and generate quotes.
                      </p>
                    </div>

                    <div className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-[color:var(--planner-primary)] transition group-hover:text-[color:var(--planner-primary-hover)] group-hover:gap-3">
                      Open Planner
                ...
                <Link
                  href="/configurator"
                  className="group relative overflow-hidden rounded-[1.8rem] border border-[color:var(--planner-border-soft)] bg-[linear-gradient(180deg,rgba(19,33,61,0.96),rgba(9,18,36,0.98))] p-5 text-white shadow-theme-float transition hover:-translate-y-1 hover:border-white/35 hover:shadow-[0_24px_64px_rgba(0,0,0,0.28)]"
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-4 rounded-[1.45rem] border border-white/10 bg-white/6 p-4">
                      <div className="relative h-44 overflow-hidden rounded-[1.2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,15,31,0.92),rgba(14,23,45,0.96))]">
                        ...
                        <div className="absolute bottom-4 left-5 right-5 flex items-center justify-between gap-3 text-[10px] font-semibold uppercase tracking-[0.18em] text-white/55">
                          <span>Scene</span>
                          <span>Camera</span>
                          <span>Export</span>
                        </div>
                    ...
                    <div className="mt-3 overflow-hidden transition-all duration-300 max-h-0 opacity-0 group-hover:max-h-16 group-hover:opacity-100">
                      <p className="text-xs leading-5 text-white/60">
                        Walk through your layout as a spatial scene.
                      </p>
                    </div>

                    <div className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-white transition group-hover:text-[color:var(--planner-accent)] group-hover:gap-3">
                      Open 3D View
                      <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                    </div>
                  </div>
