    ...
    <section className="scheme-page flex min-h-screen flex-col items-center">
      ...
      <section className="container px-6 py-16 2xl:px-0 md:py-20">
        <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
          <aside className="scheme-panel-dark rounded-blob p-7 md:p-9">
            ...
            <div className="mt-8 border-t scheme-border pt-7">
              <h3 className="scheme-text-inverse-muted text-sm font-semibold uppercase tracking-widest">
          ...
          <div className="scheme-panel scheme-border rounded-blob border p-7 md:p-9">
            ...
            <div className="scheme-panel-soft scheme-border mt-10 overflow-hidden rounded-huge border">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-soft text-left text-sm">
                  ...
                  <tbody className="divide-y divide-soft surface-overlay-92">
                    {COOKIE_ROWS.map((row) => (
                      <tr key={row.name}>
