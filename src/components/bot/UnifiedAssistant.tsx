  ...
  return (
    <>
      ...
      <div className="hidden sm:block">
        ...
        >
          <Sparkles className="h-4 w-4" />
          <span className="hidden xl:inline text-xs font-semibold uppercase tracking-widest">
          ...
          <div className="relative flex max-h-[92vh] w-full max-w-[640px] flex-col overflow-hidden rounded-t-3xl bg-panel shadow-2xl sm:rounded-2xl">
            ...
            <div className="border-b border-soft bg-primary/5 px-5 py-3">
              ...
              <button
                ...
                className="mt-2 inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-primary"
              >
            ...
            <div className="border-t border-soft p-4">
              ...
              <form onSubmit={handleAiSubmit} className="flex items-end gap-2">
                ...
                <button
                  ...
                  className="inline-flex min-h-11 items-center gap-2 rounded-lg bg-inverse px-4 text-xs font-semibold uppercase tracking-wider text-inverse transition-colors hover:bg-primary disabled:cursor-not-allowed disabled:opacity-50"
                >
